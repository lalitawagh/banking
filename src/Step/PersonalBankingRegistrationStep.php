...
class PersonalBankingRegistrationStep extends Item
{
    ...
    public function getItems(): array
    {
        ...
        $steps = [
            ...
            new StepItem(membership_type: 'personal', label: 'Address & DOB', step: RegistrationStep::ADDRESS ,source :'web', url: route('customer.signup.address.index'),priority:7000),
            new StepItem(membership_type: 'personal', label: 'KYC Documents', step: RegistrationStep::DOCUMENTS ,source :'web', url: route('customer.signup.kyc.index'),priority:8000),
            
        ];

        $steps[] = new StepItem(membership_type: 'personal', label: 'Account Preview', step: RegistrationStep::ACCOUNT_PREVIEW ,source :'web', url: route('customer.signup.ledger.index'),priority:9000);
        $steps[] = new StepItem(membership_type: 'personal', label: 'Ledger', step: RegistrationStep::LEDGER ,source :'web', url: route('customer.signup.ledger-show'),priority:10000);
        
        if($user->is_banking_user != true)
        {
            $steps[] =  new StepItem(membership_type: 'personal', label: 'Dashboard', step: RegistrationStep::DASHBOARD ,source :'web', url: route('dashboard.index'),priority:11000);
        }
