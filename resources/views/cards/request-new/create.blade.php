        ...
        <form x-data="createRequestNewCardForm()" action="{{ route('dashboard.cards.store') }}" method="POST">
            ...
            <div class="grid grid-cols-12 lg:gap-10 sm:gap-3">
                <div class="col-span-12 md:col-span-8 lg:col-span-6  form-inline mt-0">
                    <label for="sender_account_id" class="form-label sm:w-30">Bank Account <span class="text-theme-6">*</span></label>
                    <div class="sm:w-5/6 mob">
                    <select
                        id="account_id"
                        name="account_id"
                        class="@if ($errors->has('account_id')) border-theme-6 @endif"
                        data-search="true"
                        x-ref="activeAccountDropdownRef"
                        x-on:change="changeActiveAccount($el)"
                    >
                ...
                <div class="col-span-12 md:col-span-8 lg:col-span-6  form-inline mt-2 sm:mt-0">
                    <label for="bank_account_status" class="form-label sm:w-30">Account Status <span class="text-theme-6">*</span></label>
                    <div class="sm:w-5/6">
                    <input
            ...
            <div class="text-right mt-5 form-inline text-right mt-5 float-right">
                <a href="{{ route('dashboard.cards.index', ['filter' => ['workspace_id' => $workspace->id]]) }}" class="btn btn-secondary w-24 inline-block mr-2">Cancel</a>
